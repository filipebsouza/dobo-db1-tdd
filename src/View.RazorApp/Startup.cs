...
namespace View.RazorApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IArmazenadorDeCliente, ArmazenadorDeCliente>();
            services.AddScoped<IValidadorDeClienteComCpfJahCadastrado, ValidadorDeClienteComCpfJahCadastrado>();
